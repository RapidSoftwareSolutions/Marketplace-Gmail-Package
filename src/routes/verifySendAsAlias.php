<?php
$app->post('/api/Gmail/verifySendAsAlias', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'users/' . $email . '/settings/sendAs/'.$post_data['args']['sendAsEmail'].'/verify';
