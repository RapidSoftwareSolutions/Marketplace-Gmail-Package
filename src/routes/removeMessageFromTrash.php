<?php
$app->post('/api/Gmail/removeMessageFromTrash', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'users/' . $email . '/messages/' . $post_data['args']['messageId'] . '/untrash';
