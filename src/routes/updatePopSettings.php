<?php
$app->post('/api/Gmail/updatePopSettings', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'users/' . $email . '/settings/pop';

    if (!empty($post_data['args']['accessWindow'])) {
        $body['accessWindow'] = $post_data['args']['accessWindow'];
    }
